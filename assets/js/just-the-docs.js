...
function initSearch() {
  ...
  request.open('GET', '/pages/study-game-engines/f3d/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/pages/study-game-engines/f3d/assets/css/just-the-docs-' + theme + '.css');
}
